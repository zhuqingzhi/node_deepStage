...
const s = {
    ...
    , r = t => "function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(t) : t && t.buffer instanceof ArrayBuffer
    , o = ({ type: e, data: s }, o, h) => n && s instanceof Blob ? o ? h(s) : a(s, h) : i && (s instanceof ArrayBuffer || r(s)) ? o ? h(s) : a(new Blob([s]), h) : h(t[e] + (s || ""))
    , a = (t, e) => {
...
const l = "function" == typeof ArrayBuffer
    ...
    , y = (t, e) => "blob" === e ? t instanceof Blob ? t : new Blob([t]) : t instanceof ArrayBuffer ? t : t.buffer
...
const A = _.setTimeout
    , O = _.clearTimeout;
function T(t, e) {
    e.useNativeTimers ? (t.setTimeoutFn = A.bind(_),
        t.clearTimeoutFn = O.bind(_)) : (t.setTimeoutFn = _.setTimeout.bind(_),
...
class C extends k {
    ...
    onError(t, e, s) {
        return super.emitReserved("error", new R(t, e, s)),
            this
    }
    open() {
...
class V extends k {
    ...
    create() {
        ...
        "undefined" != typeof document && (this.index = V.requestsCount++,
            V.requests[this.index] = this)
    }
    onError(t) {
...
const K = "function" == typeof Promise && "function" == typeof Promise.resolve ? t => Promise.resolve().then(t) : (t, e) => e(t, 0)
    ...
    websocket: class extends C {
        ...
        doOpen() {
            ...
            const t = this.uri()
                ...
                , s = W ? {} : E(this.opts, "agent", "perMessageDeflate", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "localAddress", "protocolVersion", "origin", "maxPayload", "family", "checkServerIdentity");
        ...
        uri() {
            const t = this.opts.secure ? "wss" : "ws"
                , e = this.query || {};
            return this.opts.timestampRequests && (e[this.opts.timestampParam] = j()),
                                    ...
                                    for (n.push(a); ;) {
                                        if (0 === i) {
                                            ...
                                            if (w(n) < 2)
                                                break;
                                            const t = v(n, 2);
                                            r = new DataView(t.buffer, t.byteOffset, t.length).getUint16(0),
                                                i = 3
                                        } else if (2 === i) {
                                            if (w(n) < 8)
                                                break;
                                            ...
                                            r = o * Math.pow(2, 32) + e.getUint32(4),
                                                i = 3
                                        } else {
                                            if (w(n) < r)
                                                break;
                                            const t = v(n, r);
                                            h.enqueue(d(o ? t : b.decode(t), e)),
                                                i = 0
                                        }
                                        if (0 === r || r > t) {
                                            h.enqueue(s);
    ...
    polling: class extends C {
        ...
        uri() {
            const t = this.opts.secure ? "https" : "http"
                , e = this.query || {};
            return !1 !== this.opts.timestampRequests && (e[this.opts.timestampParam] = j()),
...
class X extends k {
    constructor(t, e = {}) {
        super(),
            ...
            t ? (t = Q(t),
                ...
                e.port = t.port,
                t.query && (e.query = t.query)) : e.host && (e.hostname = Q(e.host).host),
            T(this, e),
    ...
    open() {
        let t;
        if (this.opts.rememberUpgrade && X.priorWebsocketSuccess && -1 !== this.transports.indexOf("websocket"))
            t = "websocket";
        else {
        ...
        for (let s = 0; s < this.writeBuffer.length; s++) {
            ...
            if (n && (t += "string" == typeof (e = n) ? function (t) {
                ...
                for (let n = 0, i = t.length; n < i; n++)
                    e = t.charCodeAt(n),
                        e < 128 ? s += 1 : e < 2048 ? s += 2 : e < 55296 || e >= 57344 ? s += 3 : (n++,
                            s += 4);
                return s
...
const G = "function" == typeof ArrayBuffer
    , Z = t => "function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(t) : t.buffer instanceof ArrayBuffer
...
function it(t, e) {
    ...
    for (const e in t)
        if (Object.prototype.hasOwnProperty.call(t, e) && it(t[e]))
            return !0;
    return !1
}
function rt(t) {
...
const ct = ["connect", "connect_error", "disconnect", "disconnecting", "newListener", "removeListener"]
    , ut = 5;
var pt;
!function (t) {
...
class dt extends k {
    ...
    add(t) {
        ...
        if ("string" == typeof t) {
            ...
            s || e.type === pt.BINARY_ACK ? (e.type = s ? pt.EVENT : pt.ACK,
    ...
    static isPayloadValid(t, e) {
        switch (t) {
            ...
            case pt.BINARY_EVENT:
                return Array.isArray(e) && ("number" == typeof e[0] || "string" == typeof e[0] && -1 === ct.indexOf(e[0]));
            case pt.ACK:
            case pt.BINARY_ACK:
...
var yt = Object.freeze({
    ...
    Encoder: class {
        ...
        encodeAsString(t) {
            let e = "" + t.type;
            return t.type !== pt.BINARY_EVENT && t.type !== pt.BINARY_ACK || (e += t.attachments + "-"),
                t.nsp && "/" !== t.nsp && (e += t.nsp + ","),
                null != t.id && (e += t.id),
...
class vt extends k {
    ...
    socket(t, e) {
        let s = this.nsps[t];
        return s ? this._autoConnect && !s.active && s.connect() : (s = new bt(this, t, e),
            this.nsps[t] = s),
            s
    }
    _destroy(t) {
...
function _t(t, e) {
    ...
    const s = function (t, e = "", s) {
        ...
        return n.id = n.protocol + "://" + i + ":" + n.port + e,
    ...
    let a;
    return e.forceNew || e["force new connection"] || !1 === e.multiplex || o ? a = new vt(n, e) : (kt[i] || (kt[i] = new vt(n, e)),
        a = kt[i]),
...
export { vt as Manager, bt as Socket, _t as connect, _t as default, _t as io, ut as protocol };
